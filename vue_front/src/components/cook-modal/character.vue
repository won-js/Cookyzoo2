        ...
        >
          <div class="wrap">
            <img
              class="rabbit"
              id="animalImage"
              v-on:mouseover="hoverAnimal(i, animal.image, animal.thumbnail)"
              v-on:mouseout="hoverAnimal(i, animal.image, animal.thumbnail)"
              :src="animal.image"
              alt=""
            />
            <div class="arrow_box">
...
export default {
  ...
  methods: {
    ...
    hoverAnimal(i, image, thumbnail) {
      this.animals[i].image = thumbnail;
      this.animals[i].thumbnail = image;
    },
  },
  created() {
  ...
  mounted() {
    this.animals = this.getAnimals.slice();
  },
};
</script>
